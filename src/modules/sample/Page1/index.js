      ...
      <Grid container spacing={4}>
        <Grid item xs={12}>
          <Stack direction="row"  alignItems="center" justifyContent="flex-start" spacing={3}>
            <Stack direction="column" spacing={3}>
              <Typography variant='h1'>Hello User T0001, Welcome back</Typography>
              {/* input time and date here */}
              <Typography variant='body1'>11.20 AM Senin, 26 Februari 2024</Typography>
            </Stack>
            <img src={person} style={{height:'90px', paddingRight: "60px"}}/>
            <IconButton>
              <img src={Refresh}/>
            </IconButton>
          </Stack>
        ...
        <Grid item xs={9}>
          <Stack direction="column" spacing={4}>
            ...
            <Stack direction="row" alignItems="center" justifyContent="flex-start" spacing={25}>
              <Mail_Status 
              image={Disposisi} 
              text="Disposisi" 
              boxColor="#429777" 
          ...
          <Stack direction="column" spacing={5}>
            ...
            <Box sx={{backgroundColor: '#DFE4F7', borderRadius: 2}}>
              ...
              <Box sx={{backgroundColor: "white"}}>
                <Stack direction="row" spacing={3}  alignItems="flex-start" justifyContent="flex-start">
                  <Badge 
                  overlap="circular"
                  color='primary'
                  ...
                  <Stack direction="column"spacing={2}>
                    ...
                    <Box sx={{backgroundColor: "#A3E6CD", height: '22px', weight: '44px'}}>
                      <Typography sx={{height: '22px', weight: '44px'}}>Aktif</Typography>
                    </Box>
                    <Typography>Taufik Sulaeman/8900002/ARMS</Typography>
                    <Button variant="contained"disableElevation sx={{backgroundColor:"#FFEFD2", color:"black"}}>
              ...
              <Box sx={{backgroundColor: "white"}}>
                <Stack direction="row" spacing={3} alignItems="flex-start" justifyContent="flex-start" >
                  ...
                  <Stack direction="column" spacing={2}>
                    <Typography variant='h3'>Manager development</Typography>
                    <Box sx={{backgroundColor: "#A3E6CD", height: '22px', weight: '44px'}}>
                      <Typography sx={{height: '22px', weight: '44px'}}>Aktif Sampai 22 sep </Typography>
                    </Box>
                    <Typography>Taufik Sulaeman/8900002/ARMS</Typography>
                  </Stack>
                </Stack>
